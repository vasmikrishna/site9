            ...
            <div>
              ...
              <div className="space-y-4">
                <ContactItem
                  ...
                  label="Email"
                  value="hello@site9.in"
                  href="mailto:hello@site9.in"
                />
                <ContactItem
                  icon={<MapPin className="h-5 w-5" />}
                  label="Location"
                  value="Online — serving businesses everywhere"
                />
                <ContactItem
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <FormField label="Service interested in">
                      ...
                      >
                        ...
                        <option value="showcase">Show off your business</option>
                        <option value="grow">Get found &amp; grow</option>
