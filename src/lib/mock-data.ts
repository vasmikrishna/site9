...
export const MOCK_PORTFOLIO: PortfolioItem[] = [
  { id: "port1", title: "Spice Route Café", description: "Cozy neighbourhood café — menu, photos, and WhatsApp table enquiries.", tags: ["Café", "Menu", "WhatsApp"], image_url: "https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?w=800&q=80", live_url: "#", visible: true, sort_order: 1, created_at: "2026-05-02T10:00:00Z" },
  { id: "port2", title: "Glow Beauty Salon", description: "Hair & beauty salon with services, pricing, and instant WhatsApp booking.", tags: ["Salon", "Bookings", "Gallery"], image_url: "https://images.unsplash.com/photo-1560066984-138dadb4c035?w=800&q=80", live_url: "#", visible: true, sort_order: 2, created_at: "2026-05-05T10:00:00Z" },
  { id: "port3", title: "Aperture Studio", description: "Wedding & portrait photographer portfolio with an enquiry form.", tags: ["Photography", "Portfolio", "Enquiries"], image_url: "https://images.unsplash.com/photo-1452587925148-ce544e77e70d?w=800&q=80", live_url: "#", visible: true, sort_order: 3, created_at: "2026-05-08T10:00:00Z" },
  { id: "port4", title: "Sunrise PG & Hostel", description: "PG accommodation with room photos, amenities, and Google Maps directions.", tags: ["PG / Hostel", "Rooms", "Maps"], image_url: "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=800&q=80", live_url: "#", visible: true, sort_order: 4, created_at: "2026-05-11T10:00:00Z" },
  { id: "port5", title: "FitZone Gym", description: "Local gym with class timings, trainer profiles, and membership enquiries.", tags: ["Fitness", "Timings", "Leads"], image_url: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=800&q=80", live_url: "#", visible: true, sort_order: 5, created_at: "2026-05-14T10:00:00Z" },
  { id: "port6", title: "Trendz Boutique", description: "Fashion boutique showing the latest collection with WhatsApp ordering.", tags: ["Boutique", "Catalogue", "WhatsApp"], image_url: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=800&q=80", live_url: "#", visible: true, sort_order: 6, created_at: "2026-05-17T10:00:00Z" },
]
